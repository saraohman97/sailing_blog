  ...
  return (
    <div className="bg-white h-[150px] w-full">
      <div className="pt-8 flex flex-col items-center justify-end gap-2 h-full max-w-screen-xl mx-auto">
        ...
        <div className="font-serif text-sm flex gap-2 justify-center w-full relative">
          {links.map((link) => (
            <Link
              key={link.label}
              href={link.href}
          ...
          <div className="bg-black text-white rounded px-6 py-2 w-fit absolute right-0 bottom-0 max-xl:mr-4 mb-4">
            Logga in
          </div>
        </div>
      </div>
